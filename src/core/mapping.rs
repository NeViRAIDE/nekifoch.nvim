...
// }
//
// pub fn default_keymaps_for_size(buf: &mut Buffer) -> OxiResult<()> {
//     let enter_cmd = r#"<cmd>lua local font_size = vim.api.nvim_get_current_line(); vim.cmd('Nekifoch set_size ' .. font_size)<CR>"#;
//     set_keymaps_for_buffer(buf, enter_cmd, CLOSE_COMMAND)
// }
